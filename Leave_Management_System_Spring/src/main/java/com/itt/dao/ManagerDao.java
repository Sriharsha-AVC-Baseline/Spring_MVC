...
public class ManagerDao  {
	...
	public void insert(ManagerEntity manager)
	{
	...
	public List<ExecutiveEntity> sendManagerEntity(EmployeeEntity managerDetails)
	{
		return (List<ExecutiveEntity>)this.hibernateTemplate.get("myExecutives", managerDetails);
	}

	
	public void approveLeaves(int leaveId) {
		
		giveVerdict(leaveId, LeaveStatus.APPROVED.toString());
	}
	...
	public void revokeLeaves(int leaveId) {
		...
		giveVerdict(leaveId, LeaveStatus.REVOKED.toString());
	}
