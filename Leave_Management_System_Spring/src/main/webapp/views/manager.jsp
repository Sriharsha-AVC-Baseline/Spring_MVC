...
/*   String message = request.;
  	if(name != null)
  	{
  		message = "Swal.fire('Welcome "+name+"')";
  	}
  	
  	String postMessage = (String)request.getAttribute("message"); */
	...
	<div id="header" >
        ...
        <div class="drop">
            ...
            <div id="Content" class="contents" >
                ...
                <%-- <li><%= session.getAttribute(SessionAttributeNames.EMPLOYEE_NAME) %></li>
                <li><%= session.getAttribute(SessionAttributeNames.EMPLOYEE_DESIGNATION) %></li> --%>
      ...
      <div id="sidemenu">
           ...
           <a href="GetList"><button>Employee List</button></a> <br>
