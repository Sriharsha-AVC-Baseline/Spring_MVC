...
<h2 style="text-align: center;">Revoke Leave</h2>

<form action="SubmitRevoke" method="post">
<div>
...
<c:forEach items="${sessionScope.records}" var="element"> 
  <tr>
    ...
    <td><button type="submit" id="leaveID" name="leaveId" value="${element.getLeaveID()}" class="btn btn-danger">Revoke</button></td>
...
<a style="margin-left:44%;padding: 10px;padding-left: 20px;padding-right: 20px;color: white;text-decoration: none;background-color: green;border-radius: 10px" href="back">Back</a>
</div>
</div>
