...
<h2 style="text-align: center;">Avail Leave</h2>
<form action="SubmitAvailLeave" method="post">
<div>
...
<c:forEach items="${requestScope.approvedLeaves}" var="element"> 
  <tr>
    ...
    <td>${element.getNumberOfDays()}</td>
     <td><button type="submit" id="leaveID" name="leaveId" value="${element.getLeaveID()}" class="btn btn-sucess">Avail</button></td>
  </tr>
</c:forEach>
</table>
<br>
<button type="submit" class="btn btn-danger" style="margin-left: 44%;">Submit</button>
